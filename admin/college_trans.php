...
<head>
    ...
    <title>Admin | College Transactions</title>
    ...
    $colleges = CollegePayment::find_all();
    ?>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                      <h5 class="txt-dark">College Transactions</h5>
                    </div>
                </div>
                <!-- /Title -->
                                        ...
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <?php 
                                                        $faculty = College::find_by_id($college->college_id);
                                                        $school = School::find_by_id($faculty->school_id);
                                                        ?>
                                                        <td><?php echo $school->school_name?></td>
                                                        
                                                        <td><?php echo $faculty->cf_name;?></td>
