...
<head>
	...
	<title>Admin | Department Records</title>
			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Department Records</h5>
					</div>
				</div>
				<!-- /Title -->
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														<?php $school = School::find_by_id($department->school_id); ?>
														<td><?php echo $school->school_name; ?></td>
														<td><?php echo $department->dept_name;?></td>
														<td>&#8358;<?php echo $department->amount/100;?></td>
														<td><?php echo $department->dept_bank;?></td>
														<td><?php echo $department->dept_acc_no;?></td>
														<td><?php echo $department->dept_acc_name;?></td>
														<td><?php echo $department->account_code;?></td>
														<td><?php echo $department->contact_email;?></td>
														<td><?php echo $department->contact_name;?></td>
														<td><?php echo $department->dept_contact;?></td>
														 <td><a href="edit_department.php?id=<?php echo $department->id;?>" class="" data-toggle="tooltip" title="Edit" ><i class="zmdi zmdi-edit text-primary"></i></a> 
												<a href="delete_department.php?id=<?php echo $department->id;?>" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="zmdi zmdi-delete text-danger"></i></a></td>
													</tr>
													<?php endforeach;?>
												</tbody>
											</table>
