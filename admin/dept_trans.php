...
<head>
    ...
    <title>Admin | Department Transactions</title>
    ...
    $departments = DeptPayment::find_all();
            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                      <h5 class="txt-dark">Department Transactions</h5>
                    </div>
                </div>
                <!-- /Title -->
                                        ...
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <?php $dept = Department::find_by_id($department->dept_id); 
                                                         $school = School::find_by_id($dept->school_id);?>
