    ...
    $college = College::find_by_id($_GET['id']);
         ...
         if(isset($_POST['cf_submit'])) {
           if($college){
           		...
           		$college->account_code = $_POST['account_code'];
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Edit College/Faculty Information</h5>
						</div>
					</div>
					<!-- /Title -->
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-money"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="cf_amount" value="<?php echo $college->amount;?>">
											</div>
										</div>
											<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
											<div class="input-group-addon"><i class="fa fa-user"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="account_code" value="<?php echo $college->account_code;?>">
											</div>
										</div>
									 <div class="form-group">
