...
<head>
		...
		include('include/init.php');
		 ...
		 $colleges = College::find_all_colleges($_GET['school_id']);
								...
								<div  class="panel-body pb-0">
									<div  class="tab-struct custom-tab-1">
										<ul role="tablist" class="nav nav-tabs nav-tabs-responsive" id="myTabs_8">
											<li role="presentation" class=""><a  data-toggle="tab" id="settings_tab_8" role="tab" href="#college" aria-expanded="false"><span>College/Faculty Fee Payment</span></a></li>
										</ul>
									...
									<form action="cpayment.php" method="post">
										...
										<div class="form-group">
								         <label class="control-label mb-10">Select College</label>
								<select class="form-control" data-placeholder="Choose a Category" tabindex="1" name="college">
									<?php foreach($colleges as $college):?>
								<option value="<?php echo $college->id;?>">
									
									<?php echo $college->cf_name;?>
