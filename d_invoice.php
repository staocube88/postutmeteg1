...
<head>
		...
		include('include/init.php');
         ...
         $dept_payment = DeptPayment::find_by_id($_GET['id']);
         $dept = Department::find_by_id('$dept_payment->dept_id');
                                        ...
                                        <h4 class=" text-center">Payment Details</h4><br>
												<table class="table table-bordered table-striped">
												  ...
												  <?php echo
													...
													<th>$dept_payment->student_name</th>
												   </tr>
												   <tr>
													<th><strong>Matric Number</strong></th>
													<th>$dept_payment->matric_no</th>
                                                   </tr>
                                                   <tr>
                                                   <th><strong>Paid To</strong></th>
                                                   <th> $dept->dept_name Department</th>
                                                  </tr>
												   <tr>
													<th><strong>Amount Paid</strong></th>
													<th>&#8358;" .$dept->amount/100;"</th>
                                                   </tr>
                                                    "; 
												     ?> 
												  </tbody>
