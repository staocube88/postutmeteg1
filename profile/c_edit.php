...
<?php
    ...
    $college = College::find_by_id($_SESSION['id']);
       ...
       <!-- Left Sidebar Menu -->
        <div class="fixed-sidebar-left">
            <ul class="nav navbar-nav side-nav nicescroll-bar">
                ...
                <li>
                    <a href="c_profile.php"><div class="pull-left"><i class="fa fa-money mr-20"></i><span class="right-nav-text">Transactions</span></div><div class="clearfix"></div></a>
                </li>
                <li>
                    ...
                    <ul id="icon_dr" class="collapse collapse-level-1">
                                          <li>
                    <a href="c_edit.php"><div class="pull-left"><span class="right-nav-text">Edit Details</span></div><div class="clearfix"></div></a>
                </li>
                <li>
                    <a href="c_password.php"><div class="pull-left"><span class="right-nav-text">Change Password</span></div><div class="clearfix"></div></a>
                </li>
                    </ul>
                </li>
            </ul>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Edit Detail</h5>
						</div>
					</div>
					<!-- /Title -->
									...
									<div class="panel-body">
										...
										<div class="form-body overflow-hide">
										  <div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-institution"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="cf_name" value="<?php echo $college->cf_name;?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-money"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="cf_amount" value="<?php echo $college->amount/100;?>">
											</div>
										</div>
											<div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-building"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="cf_bank" value="<?php echo $college->cf_bank;?>">
											</div>
										</div>
											<div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-edit"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="cf_acc_no" maxlength="10" value="<?php echo $college->cf_acc_no;?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-user"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="cf_acc_name" value="<?php echo $college->cf_acc_name;?>">
											</div>
										</div>
									 ...
									 <div class="form-group">
										...
										<div class="input-group-addon"><i class="icon-phone"></i></div>
										  <input type="text" class="form-control" id="exampleInputContact_01" name="cf_contact" value="<?php echo $college->cf_contact;?>">
										</div>
									</div>
										<div class="form-group">
										...
										<div class="input-group-addon"><i class="icon-envelope"></i></div>
										  <input type="text" class="form-control" id="exampleInputContact_01" name="contact_email" value="<?php echo $college->cf_email;?>">
										</div>
									</div>
										<div class="form-group">
										...
										<div class="input-group-addon"><i class="icon-user"></i></div>
										  <input type="text" class="form-control" id="exampleInputContact_01" name="contact_name" value="<?php echo $college->contact_name;?>">
										</div>
									</div>
								    </div>	
									<div class="form-actions mt-10">			
										<button type="submit" class="btn btn-success mr-10 mb-30" name="cf_submit">Update</button>
									</div>											
									</form>	
