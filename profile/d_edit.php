    ...
    $department = Department::find_by_id($_SESSION['id']);
         ...
         if(isset($_POST['dept_submit'])) {
           if($department){
           		...
           		$department->dept_acd_no = $_POST['dept_acd_no'];
           		$department->dept_acd_name = $_POST['dept_acd_name'];
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="input-group-addon"><i class="fa fa-money"></i></div>
											   <input type="text" class="form-control" id="exampleInputEmail_01" name="dept_amount" value="<?php echo $department->amount/100;?>">
											</div>
										</div>
											<div class="form-group">
									 ...
									 <div class="form-group">
										...
										<div class="input-group-addon"><i class="icon-envelope"></i></div>
										  <input type="text" class="form-control" id="exampleInputContact_01" name="contact_email" value="<?php echo $department->contact_email;?>">
										</div>
									</div>
										<div class="form-group">
